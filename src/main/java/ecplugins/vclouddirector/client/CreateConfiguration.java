    ...
    extends InternalFormBase
{
    ...
    {
        super("New vCloudDirector Configuration", "vCloudDirector Configurations");
    ...
    @Override protected void load()
    {
        ...
        loader.setCustomEditorPath("/plugins/EC-vCloudDirector"
                + "/project/ui_forms/vCloudDirectorCreateConfigForm");
        loader.load();
        clearStatus();
    }
