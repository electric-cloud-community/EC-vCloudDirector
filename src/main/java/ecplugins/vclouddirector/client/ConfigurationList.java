...
/**
 * EC-vCloudDirector Configuration List.
 */
    ...
    extends ListBase
{
    ...
    private vCloudDirectorConfigList m_configList;

    //~ Constructors -----------------------------------------------------------

    public ConfigurationList()
    {
        super("ecgc", "vCloudDirector Configurations", "All Configurations");
        m_configList = new vCloudDirectorConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        vCloudDirectorConfigListLoader loader = new vCloudDirectorConfigListLoader(m_configList, this,
                new ChainedCallback() {
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-vCloudDirector/project");
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the vCloudDirector configuration '"
                            + configName + "'?") {
    ...
    private void waitForJob(final String jobId)
    {
        CgiRequestProxy     cgiRequestProxy = new CgiRequestProxy(
                getPluginName(), "vclouddirectorMonitor.cgi");
