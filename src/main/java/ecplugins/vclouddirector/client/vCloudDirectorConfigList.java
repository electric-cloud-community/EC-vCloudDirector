...
// vCloudDirectorConfigList.java --
//
// vCloudDirectorConfigList.java is part of ElectricCommander.
//
...
public class vCloudDirectorConfigList
{

    //~ Instance fields --------------------------------------------------------

    private final Map<String, vCloudDirectorConfigInfo> m_configInfo =
        new TreeMap<String, vCloudDirectorConfigInfo>();
    ...
    public void addConfig(
            ...
            String configServer)
    {
        m_configInfo.put(configName, new vCloudDirectorConfigInfo(configServer));
    }
    ...
    private class vCloudDirectorConfigInfo
    {
        ...
        public vCloudDirectorConfigInfo(String server)
        {
            m_server = server;
        }
    }
